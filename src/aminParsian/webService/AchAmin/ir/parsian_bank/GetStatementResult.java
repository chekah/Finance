...
import aminParsian.webService.AchAmin.com.caspian.channelmanager.core.webservicegateway.endpoint.corebankingservice.ChStatementResponseBean;
 ...
 *       &lt;sequence>
 *         &lt;element name="response" type="{http://corebankingservice.endpoint.webservicegateway.core.channelmanager.caspian.com/}chStatementResponseBean" minOccurs="0"/>
...
public class GetStatementResult {
    ...
    protected ChStatementResponseBean response;
     ...
     *     
     */
    public ChStatementResponseBean getResponse() {
        return response;
    }
     ...
     *     
     */
    public void setResponse(ChStatementResponseBean value) {
        this.response = value;
    }
