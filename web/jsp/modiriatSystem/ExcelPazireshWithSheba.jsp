...
<s:form id="pazireshForm" name="pazireshForm" enctype="multipart/form-data" method="post">
    <table id=table1 class="table ">
        ...
        <tr>
            ...
            <td>
                    <sec:authorize access="hasRole('ModiriatSystemSabteExcelPazireshWithSheba')">
                <s:submit type="button" class="submitButton" action="ModiriatSystemSabteExcelPazireshWithSheba" name="saveFile"
