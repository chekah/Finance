...
<script src="/js/produceLetter.js"></script>
...
<s:form method="post">
    ...
    <table class="table">
        ...
        <tr>
            <td>
                <sec:authorize access="hasRole('LetterProduceLetterInsured')">
                    <input class="submitButton" theme="simple" formaction="LetterProduceLetterInsured" align="center" type="submit"  value="تولید صورتحساب"/>
                </sec:authorize>
