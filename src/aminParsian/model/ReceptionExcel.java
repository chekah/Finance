...
@Entity
@Table(name = "ReceptionExcel")
@NamedQueries({
        @NamedQuery(name = "ReceptionExcel.findAll", query = "SELECT re  FROM ReceptionExcel  re")})
public class ReceptionExcel  implements Serializable {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    private ReceptionExcelFiles receptionExcelFile;
    ...
    @Column(name = "MABLAGHMOTABEGHTAREFE")
    private BigInteger mablaghMotabeghTarefe;

    @Column(name = "TARIKHENTEGHAL")
    private String tarikheEnteghal;

    @Column(name = "ZAMANENTEGHAL")
    private String zamanEnteghal;

    @Column(name = "SHEBA")
    private String sheba;

    @JoinColumn(name = "RECEPTIONEXCELNOTEXISTIP", referencedColumnName = "ID")
    @ManyToOne(fetch = FetchType.LAZY)
    private ReceptionExcelNotExistIP receptionExcelNotExistIP;

    private transient String stateStr;

    public ReceptionExcel() {
    }
//*************************************************************
    ...
    public ReceptionExcelFiles getReceptionExcelFile() {
        return receptionExcelFile;
    }

    public void setReceptionExcelFile(ReceptionExcelFiles receptionExcelFile) {
        this.receptionExcelFile = receptionExcelFile;
    }
    ...
    public String getTarikheEnteghal() {
        return tarikheEnteghal;
    }

    public void setTarikheEnteghal(String tarikheEnteghal) {
        this.tarikheEnteghal = tarikheEnteghal;
    }

    public String getZamanEnteghal() {
        return zamanEnteghal;
    }

    public void setZamanEnteghal(String zamanEnteghal) {
        this.zamanEnteghal = zamanEnteghal;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReceptionExcel)) {
            return false;
        }
        ReceptionExcel other = (ReceptionExcel) object;
    ...
    public String toString() {
        return "model.ReceptionExcel[ id=" + id + " ]";
    }
}
