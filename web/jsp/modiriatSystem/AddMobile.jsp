...
<s:form  method="post" enctype="multipart/form-data">
    <div class="flip">
ثبت شماره موبایل برای بیمه شده
    </div>
    ...
    <table class="table">
        <tr >
            ...
            <td>
                <a href="ModiriatSystemDownLoadSampleFileForSabteMobile" class="submitButton">دانلود فايل نمونه </a>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="3"></td>
            <td>
                <sec:authorize access="hasRole('ModiriatSystemSaveMobile')">
                    <input class="submitButton" theme="simple" formaction="ModiriatSystemSaveMobile" align="center" type="submit"  value="ثبت"/>
                </sec:authorize>
            </td>
...
<div style="overflow: auto;">
    <display:table export="true" name="paginatedViewInsuredPersonList" id="paginatedViewInsuredPersonList"
                   ...
                   sort="external" htmlId="dbList" excludedParams="" requestURI="/ModiriatSystemSaveMobileFile.action">
        ...
        <display:column property="mobile" title="شماره موبایل"> </display:column>
